...
public class JSONParserGroupInfo extends AsyncTask<JSONObject, Void, JSONArray> {
	
	InputStream in;
	JSONObject jsonresponse;
	JSONArray tags;
	private final String url = "https://www.compile.no/ci/home/read";
	...
	protected JSONArray doInBackground(JSONObject... json) {
        ...
        try {
            ...
            if(response!=null){
                ...
                tags = jsonresponse.getJSONArray("tags");
            }
